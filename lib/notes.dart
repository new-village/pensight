...
// Note class: manages title and content separately.
class Note {
  String title;
  String content;
...
class _NotesPageState extends State<NotesPage> {
  // Changed _notes to List<Note>
  final List<Note> _notes = [];
  int? _selectedNoteIndex;
  bool _showSidebar = true;
  bool _isFabExpanded = false;
  double _fontSize = 26; // Initial font size
  ...
  // Utility to update _selectedNoteIndex after removal.
      ...
      builder: (context) => AlertDialog(
        ...
        content: Column(
          ...
          children: [
            ...
            // ...existing code: font size slider...
            Padding(
  ...
  // Opens a dialog to rename the Note title.
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      // ...existing Scaffold and GestureDetector code...
